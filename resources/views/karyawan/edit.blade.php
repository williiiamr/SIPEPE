    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" class="form-control" readonly value="{{ $karyawan->nik }}" placeholder="NIK" name='nik' id='nik'>
            </div>
            <div class="input-icon mb-3">
                <span class="input-icon-addon">
                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                ...
                <input type="text" class="form-control" value="{{ $karyawan->nama }}" placeholder="Nama" name='nama' id='nama'>
            </div>
            <div class="input-icon mb-3">
                <span class="input-icon-addon">
                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                ...
                <input type="text" class="form-control" value="{{ $karyawan->no_hp }}" placeholder="No_telepon" name='no_telp' id='no_telp'>
            </div>
            <div class="input-icon mb-3">
                <span class="input-icon-addon">
                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
